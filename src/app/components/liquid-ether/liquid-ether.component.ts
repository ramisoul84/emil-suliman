// liquid-ether.component.ts
/*
import { Component, OnInit, OnDestroy, Input, ElementRef, AfterViewInit, HostListener } from '@angular/core';
...
export class LiquidEtherComponent implements OnInit, OnDestroy, AfterViewInit {

  // Input properties with default values
  @Input() mouseForce: number = 20;
  @Input() cursorSize: number = 100;
  @Input() isViscous: boolean = false;
  @Input() viscous: number = 30;
  @Input() iterationsViscous: number = 32;
  @Input() iterationsPoisson: number = 32;
  @Input() dt: number = 0.014;
  @Input() BFECC: boolean = true;
  @Input() resolution: number = 0.5;
  @Input() isBounce: boolean = false;
  @Input() colors: string[] = defaultColors;
  @Input() autoDemo: boolean = true;
  @Input() autoSpeed: number = 0.5;
  @Input() autoIntensity: number = 2.2;
  @Input() takeoverDuration: number = 0.25;
  @Input() autoResumeDelay: number = 1000;
  @Input() autoRampDuration: number = 0.6;

  private mountRef!: ElementRef;
  ...
  private initThreeJS() {
    ...
    // Common class for shared properties and methods
    class CommonClass {
      width = 0;
      height = 0;
      aspect = 1;
    ...
    // Mouse class for handling interactions
    class MouseClass {
      mouseMoved = false;
    ...
    // Auto driver for automatic animations
    class AutoDriver {
      mouse: MouseClass;
      manager: any;
      enabled: boolean;
  ...
  // Update when input properties change
  ngOnChanges() {
    if (this.webgl) {
      this.applyOptions();
    }
